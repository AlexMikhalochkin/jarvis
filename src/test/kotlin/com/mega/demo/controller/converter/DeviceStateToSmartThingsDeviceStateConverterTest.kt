...
internal class DeviceStateToSmartThingsDeviceStateConverterTest :
    BaseConverterTest<DeviceState, com.mega.demo.controller.generated.model.DeviceState>() {
    ...
    override fun createExpected(): com.mega.demo.controller.generated.model.DeviceState {
        return createExpected("on")
    }

    private fun createExpected(value: String): com.mega.demo.controller.generated.model.DeviceState {
        val state = State(capability = "st.switch", attribute = "switch", value = value)
        return com.mega.demo.controller.generated.model.DeviceState("id", emptyMap(), listOf(state))
    }
}
